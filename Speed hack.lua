...
WalkSpeedControl.Name = "⚡Управление Скоростью⚡"
...
WalkSpeedControl.Text = "⚡Управление скоростью⚡"
...
Label.Text = "🤑Переведено @noobasscripts🤑"
...
local function QDTZQ_fake_script() -- TextButton.LocalScript 
	...
	script.Parent.MouseButton1Click:Connect(function() --- when the button is clicked it calls this function
		...
		game.Players.LocalPlayer.Character.Humanoid.WalkSpeed = game.Players.LocalPlayer.Character.Humanoid.WalkSpeed +1--- defines the player and addition to walk speed
